...
public class ColumnSchema {
	...
	public boolean isUpdateUseridColumn() {
		return this.columnName.equalsIgnoreCase(TableSchema.UPDATE_USERID_COLUMN);
	}

	public boolean isUpdateTimeColumn() {
		return this.columnName.equalsIgnoreCase(TableSchema.UPDATE_TIME_COLUMN);
	}

	public boolean isCreateUseridColumn() {
		return this.columnName.equalsIgnoreCase(TableSchema.CREATE_USERID_COLUMN);
	}

	public boolean isCreateTimeColumn() {
		return this.columnName.equalsIgnoreCase(TableSchema.CREATE_TIME_COLUMN);
	}
